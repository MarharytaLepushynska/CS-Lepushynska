...
class ServerUDPTest {
    ...
    void shouldCreateProduct() throws InterruptedException{
        ...
        new Thread(new StoreClientUDP(queue)).start();
        new Thread(new StoreClientUDP(queue2)).start();
        Thread.sleep(1000);
    ...
    void shouldGetProductById() throws InterruptedException{
        ArrayBlockingQueue<String> queue = new ArrayBlockingQueue<>(50);
        StoreClientUDP client = new StoreClientUDP(queue);
